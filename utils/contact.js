...
const contact = {
    ...
    button: {
        label: 'Say Hello',
        onClick: () => openLink('mailto:muhammadmoiz0087n@gmail.com?subject=Hello')
    },
    designAndBuiltBy: 'Designed & Built By Muhammad Moiz Siddique',
    handleBuiltByClick: () => openLink('https://github.com/MuhammadMoiz200099/portfolio')
